        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title">Petugas</a>
            </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  ...
                  <a class="dropdown-item"  href="javascript:;">Help</a>
                    <a class="dropdown-item"  href="loginp.php"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                  </div>
                </li>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="dashboard_graph">
                ...
                <br><br><br>
                <center>
                  <a href="tb_pengaduan.php" input type="submit" class="btn btn-primary">tab_pengaduan</a>
                  <a href="validasi.php" input type="submit" class="btn btn-primary">validasi</a>
