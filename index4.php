        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title">admin</a>
            </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="dashboard_graph">
                ...
                <br><br><br>
                <center>
                  <a href="tb_pengaduan.php" input type="submit" class="btn btn-primary">tb_pengaduan</a>
                  <a href="tb_petugas.php" input type="submit" class="btn btn-primary">tb_petugas</a>
                  <a href="lihatRegistrasiMasyarakat.php" input type="submit" class="btn btn-primary">tb_registrasi Masyarakat</a>
                  <a href="verifikasiData.php" input type="submit" class="btn btn-primary">verifikasi</a>
                  <a href="petugas.php" input type="submit" class="btn btn-primary">Tambah petugas</a>
