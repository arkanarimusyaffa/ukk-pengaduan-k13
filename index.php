        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title">Menu</a>
            </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="dashboard_graph">
                ...
                <br><br><br>
                <center>
                  <a href="index2.php" input type="submit" class="btn btn-primary">Masyarakat</a>
                  <a href="index3.php" input type="submit" class="btn btn-primary">petugas</a>
                  <a href="index4.php" input type="submit" class="btn btn-primary">admin</a>
                  <a href="index5.php" input type="submit" class="btn btn-primary">surat kabar</a>
